        ...
        <div class="content">
            ...
            <div class="form-group">
                ...
                <div id="fields" class="fields">
                    ...
                    <input type="text" id="telefone" class="telefone" id="telefone" placeholder="(00) 0 0000-0000" maxlength="16" required>
                </div>
            ...
            <div id="avancar">
            <button id="btn-submit" class="btn-avancar" onclick="cadastrar()" href="/dados-clinica" ><a>Avançar</a></button>
        </div>
        </div>
    </form>
